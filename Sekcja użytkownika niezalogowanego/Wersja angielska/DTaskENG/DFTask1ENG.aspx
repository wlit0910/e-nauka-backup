<%@ Page Title="Random task" Language="C#" MasterPageFile="~/Task.Master" AutoEventWireup="true" CodeBehind="DFTask1ENG.aspx.cs" Inherits="e_nauka.Formularz_internetowy123" %>
...
<%---------------------------------------------------- TASK LOG -----------------------------------------------------%>
    <div style="height:590px;max-height:600px; ">
              ...
              <p style="font-family: Montserrat, sans-serif;font-weight: normal;margin-left:40px;margin-right:40px;text-align:justify;margin-top:30px;">
                    Complete the program that will display the text "Hello, World!" in the console. <br><br>Complete the required field or fields with the correct instruction. If you have a problem, go back to the theory.<br><br>
                  After filling in the fields, click the "Check Code" button. If the result is correct - you can proceed. Otherwise, keep trying.
                </p>
...
<%-------------------------------------------------------------------------------------------------------%>
    ...
    <asp:Button ID="Wroc_teoria" runat="server" Height="70px" BorderStyle="Solid" BorderColor="#141414" Text="Go back to theory" BackColor="#ff8454" CssClass="btnCheck" OnClick="Wroc_teoria_Click"  />
 </div>
