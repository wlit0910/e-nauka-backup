...
namespace e_nauka
{
    public partial class Contact : Page
    {
        ...
        {
           // Imie_Kontakt.Attributes.Add("placeholder", "Wpisz tutaj swoje imię.");
           // Email_Kontakt.Attributes.Add("placeholder", "Wpisz swój adres email.");      
        }
        ...
        protected void Wyslij_Kontakt_Click(object sender, EventArgs e)
        {
            try{
                ...
                try
                {
                    ...
                    using (SqlConnection conn = new SqlConnection(connectionString))
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand(insertQuery, conn))
                        {
                            ...
                            if (rowsAffected > 0)
                            {
                                ValidMessage.Text = "Twoja wiadomość została wysłana pomyślnie.";
                            ...
                            {
                                ValidMessage.Text = "Nieprawidłowe dane. Spróbuj ponownie.";
                ...
                {
                    ValidMessage.Text = "Błąd podczas aktualizacji danych: " + ex.Message;
