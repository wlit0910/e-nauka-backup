<%@ Page Title="Kontakt" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="e_nauka.Contact" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div>
      <h1 style="font-family: Montserrat, sans-serif;display:flex;justify-content:center;margin-top:70px;font-weight: normal;font-size:55px;">Skontaktuj się z nami</h1>
  </div>
...
<%--                            mozna dodac walidacje pól formularza: https://getbootstrap.com/docs/5.0/forms/validation/--%>
  ...
  margin-right: auto;">
     ...
     <div style="background-color:white; height:auto;width:500px;border-radius:30px;border-style:solid;border-color: #393939;">
            ...
            <div>
				<h3 style="text-align:center;font-weight:normal; font-family: Montserrat, sans-serif;font-size:35px;margin:25px 0px 25px 0px">Wypełnij formularz</h3>
			</div>
  ...
  <div style="text-align:center;margin-top:20px;">
      <asp:Label ID="ValidMessage" runat="server" Text="" ForeColor="Red" CssClass="laber-error" ></asp:Label>
                ...
                <asp:TextBox ID="Email_Kontakt" Height="30px" BackColor="#fae1d7"  runat ="server" BorderStyle="Solid" CssClass="content" ></asp:TextBox> 
                 ...
                 <div style="margin: 30px 30px 0px 30px;display:block;">
				<p style="font-weight: normal;font-size:20px;font-family: Montserrat, sans-serif;">Wiadomość:&hairsp;&hairsp;&hairsp;<span style="color: #ff0000">*</span></p>
                         
                     
                     <textarea id="Text_Kontakt" name="Text_Kontakt" rows="3" style="min-width:100%;border:solid;border-color:#777677;border-width:2px;background-color:#fae1d7;" placeholder="Opisz błąd, lokalizację błędu lub swoją sugestię dotyczącą ulepszenia serwisu." ></textarea>
                          ...
                          <div style="margin: 50px 30px 30px 0px;display:block;text-align:center;">
                              ...
                              <asp:Button ID="Wyslij_Kontakt" runat="server" Height="50px" BorderStyle="Solid" BorderColor="#141414" Text="Wyślij" BackColor="#ff8454" CssClass="btnContact" OnClick="Wyslij_Kontakt_Click" />
