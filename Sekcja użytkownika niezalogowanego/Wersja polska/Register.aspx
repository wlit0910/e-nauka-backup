<%@ Page Title="Rejestracja" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="e_nauka.Formularz_internetowy11" Async="true" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div style="margin-bottom:50px;text-align:center;">
      <h1 style="font-family: Montserrat, sans-serif;display:flex;justify-content:center;margin-top:70px;font-weight: normal;font-size:55px;">Stwórz swoje konto</h1>
...
<%--                            mozna dodac walidacje pól formularza: https://getbootstrap.com/docs/5.0/forms/validation/--%>
  ...
  margin-right: auto;">
     ...
     <div style="background-color:white; height:auto; max-height:1500px;width:500px;border-radius:30px;border-style:solid;border-color: #393939;margin-bottom:50px">
            ...
            <div>
				<h3 style="text-align:center;font-weight:normal; font-family: Montserrat, sans-serif;font-size:35px;margin:25px 0px 25px 0px">Zarejestruj się</h3>
			</div>

         			<div style="margin: 30px 30px 0px 30px;display:block;">
				<p style="font-weight: normal;font-size:20px;font-family: Montserrat, sans-serif;">Imię:&hairsp;&hairsp;&hairsp;<span style="color: #ff0000">*</span></p>
                ...
                <asp:TextBox ID="Imie_Rej" Height="30px" BackColor="#fae1d7"  runat ="server" BorderStyle="Solid" CssClass="content" ></asp:TextBox>  
                  ...
                  <div style="margin: 30px 30px 0px 30px;display:block;">
				<p style="font-weight: normal;font-size:20px;font-family: Montserrat, sans-serif;">Nazwisko:&hairsp;&hairsp;&hairsp;<span style="color: #ff0000">*</span></p>
                ...
                <asp:TextBox ID="Nazwisko_Rej" Height="30px" BackColor="#fae1d7"  runat ="server" BorderStyle="Solid" CssClass="content" ></asp:TextBox> 
                 ...
                 <div style="margin: 30px 30px 0px 30px;display:block;">
				<p style="font-weight: normal;font-size:20px;font-family: Montserrat, sans-serif;">Płeć:&hairsp;&hairsp;&hairsp;<span style="color: #ff0000">*</span></p>   <%--dropdown--%>
                ...
                <asp:DropDownList ID="Plec_Rej" runat="server" Height="30px" Font-Size="Medium"  style="text-align:center;border:solid;border-color:#777677;border-width:2px;background-color:#fae1d7;min-width:100%;">
                    <asp:ListItem style="font-size:small;">Kobieta</asp:ListItem>
                    <asp:ListItem style="font-size:small;text-align:center;">Mężczyzna</asp:ListItem>
                    <asp:ListItem style="font-size:small;text-align:center;">Nie podaję</asp:ListItem>
                </asp:DropDownList>
                           ...
                           <div style="margin: 30px 30px 0px 30px;display:block;">
				<p style="font-weight: normal;font-size:20px;font-family: Montserrat, sans-serif;">Wiek:&hairsp;&hairsp;&hairsp;<span style="color: #ff0000">*</span></p>
          ...
          <%--      <input ID="Wiek_Rej" type="number" min="0" max="99" class="input-age" />--%>
              ...
              <%--  <input id="Email_Rej" type="email" class="input-email" />--%>
                ...
                <div style="margin: 30px 30px 0px 30px;display:block;">
				<p style="font-weight: normal;font-size:20px;font-family: Montserrat, sans-serif;">Język:&hairsp;&hairsp;&hairsp;</p>   <%--dropdown--%>
         ...
         <%--BUTTON  REJESTRACJA --%>
                 ...
                 <div style="margin: 70px 0px 30px 0px;display:block;text-align:center;">
                              ...
                              <asp:Button ID="Rejestracja" runat="server" Height="50px" BorderStyle="Solid" BorderColor="#141414" Text="Rejestracja" BackColor="#ff8454" CssClass="btnContact" OnClick="Rejestracja_Click" />
        ...
        data-action='submit'>Submit
         ...
         <p style="text-align:center;font-weight: normal;font-size:15px;font-family: Montserrat, sans-serif;margin-top:10px;">Zgadzam się z Warunkami Użytkowania</p>
         <p style="text-align:center;font-weight: normal;font-size:15px;font-family: Montserrat, sans-serif;margin-top:-10px;"><a href="/Resources/Warunki Użytkowania.pdf" style="color:#ff6529;">Warunki Użytkowania</a></p>   
