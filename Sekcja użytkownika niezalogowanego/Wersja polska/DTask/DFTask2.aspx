<%@ Page Title="Losowe zadanie" Language="C#" MasterPageFile="~/Task.Master" AutoEventWireup="true" CodeBehind="DFTask2.aspx.cs" Inherits="e_nauka.Formularz_internetowy110" %>
...
<%---------------------------------------------------- TASK LOG -----------------------------------------------------%>
    <div style="height:590px;max-height:600px; ">
                ...
                <p style="font-family: Montserrat, sans-serif;font-weight: 500;margin-left:40px;margin-right:40px;text-align:justify;font-size:18px;text-decoration-line:underline;text-decoration-thickness:1px;text-underline-offset:5px;">
                    Zadanie - Zmienne, stałe. Typy danych.
                </p>
              ...
              <p style="font-family: Montserrat, sans-serif;font-weight: normal;margin-left:40px;margin-right:40px;text-align:justify;margin-top:30px;">
                  Dokończ program, który przechowuje informacje o produktach. <br><br>
                  Program powinien zapytać użytkownika i pobrać od niego następujące dane:</p>
                  ...
                  <ul style="font-family: Montserrat, sans-serif;font-weight: normal;margin-left:40px;margin-right:40px;text-align:justify;margin-top:10px;">
                      ...
                      <li style="margin-bottom:10px;">Nazwa produktu (zmienna typu <code>string</code>) - <span style="font-family: Montserrat, sans-serif;font-weight: normal;font-style:italic;"> "Kawa"</span></li>
                      <li style="margin-bottom:10px;">Cena produktu (zmienna typu <code>float</code>) - <span style="font-family: Montserrat, sans-serif;font-weight: normal;font-style:italic;"> "25.99"</span></li>
                 </ul>

        <p style="font-family: Montserrat, sans-serif;font-weight: normal;margin-left:40px;margin-right:40px;text-align:justify;margin-top:30px;">
            Następnie program powinien wyświetlić wprowadzone dane w następującym formacie:<br>
            <code>Produkt: Kawa</code><br>
            <code>Cena: 25.99 zł</code>
            </p>
        <p style="font-family: Montserrat, sans-serif;font-weight: normal;margin-left:40px;margin-right:40px;text-align:justify;margin-top:30px;">
            Pamiętaj, aby użyć odpowiednich typów danych dla każdej informacji. Dodatkowo, zdefiniuj stałą przechowującą stawkę VAT (np. 0.23), ale nie musisz jej wyświetlać. 
            </p>
