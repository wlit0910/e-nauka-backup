<%@ Page Title="Losowe zadanie" Language="C#" MasterPageFile="~/Task.Master" AutoEventWireup="true" CodeBehind="DFTask.aspx.cs" Inherits="e_nauka.Formularz_internetowy18" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="TaskContent" runat="server">
