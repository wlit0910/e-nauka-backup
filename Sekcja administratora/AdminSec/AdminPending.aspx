<%@ Page Title="Użytkownicy oczekujący" Language="C#" MasterPageFile="~/AdminSec/Admin.Master" AutoEventWireup="true" CodeBehind="AdminPending.aspx.cs" Inherits="e_nauka.AdminSec.Formularz_internetowy11" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1 class="label-user" >Podgląd użytkowników<br>oczekujących na rejestrację:    
    </h1>
        </div>
                 ...
                 <div style="max-height:400px; overflow-y:auto;">    
                     ...
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=MyConnectionString" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM PENDING"></asp:SqlDataSource>
                    </center>
               </div>
    ...
    <div style="display:flex;text-align:left;margin-top:40px;margin-left:50px;"> 
      <asp:Button ID="Dodaj_Admin" runat="server" Height="70px" BorderStyle="Solid" BorderColor="#141414" Text="Dodaj rekord" BackColor="#a8ccfc" CssClass="btnLogout2" OnClick="Dodaj_Admin_Click"  />
                                ...
                                <asp:TextBox ID="Add_name" Height="50px" BackColor="#deeafa"  runat ="server" BorderStyle="Solid" CssClass="input-age2"  placeholder="NAME"  ></asp:TextBox> 
                                <asp:TextBox ID="Add_surname" Height="50px" BackColor="#deeafa"  runat ="server" BorderStyle="Solid" CssClass="input-age2"  placeholder="SURNAME"  ></asp:TextBox> 
                                <asp:TextBox ID="Add_gender" Height="50px" BackColor="#deeafa"  runat ="server" BorderStyle="Solid" CssClass="input-age2" Width="55px" placeholder="GEN"  ></asp:TextBox> 
                                <asp:TextBox ID="Add_age" Height="50px" BackColor="#deeafa"  runat ="server" BorderStyle="Solid" CssClass="input-age2"  Width="63px" TextMode="Number" min="1" placeholder="AGE"  ></asp:TextBox> 
                                <asp:TextBox ID="Add_email" Height="50px" BackColor="#deeafa"  runat ="server" BorderStyle="Solid" CssClass="input-age2"  placeholder="EMAIL"  ></asp:TextBox> 
        <asp:TextBox ID="Add_lang" Height="50px" BackColor="#deeafa"  runat ="server" BorderStyle="Solid" CssClass="input-age2" Width="65px" placeholder="LANG"  ></asp:TextBox> 
        <asp:Button ID="Send_Add" runat="server" Height="70px" BorderStyle="Solid" BorderColor="#141414" Text="Dodaj" BackColor="#a8ccfc" CssClass="btnLogout" OnClick="Send_Add_Click"  />
...
.input-age5 { border:solid;border-color:#777677;border-width:2px;text-align:center;margin-top:10px;font-size:20px;font-family: Montserrat, sans-serif;font-weight: normal;color:black; border-radius:5px;opacity:0.8;margin-right:50px; }
        ...
        <asp:TextBox ID="ID_do_zmiany" Height="50px" BackColor="#deeafa" Width="50px" runat ="server" BorderStyle="Solid" CssClass="input-age5" placeholder="ID" Visible="false" ></asp:TextBox> 
                           ...
                           <asp:Button ID="Send_Edit" runat="server" Height="70px" BorderStyle="Solid" BorderColor="#141414" Text="Aktualizuj" BackColor="#a8ccfc" CssClass="btnLogout" OnClick="Send_Edit_Click"  />
...
<%--    usuwanie --%>
      ...
      <asp:Button ID="Delete_Admin" runat="server" Height="70px" BorderStyle="Solid" BorderColor="#141414" Text="Usuń rekord" BackColor="#a8ccfc" CssClass="btnLogout2" OnClick="Delete_Admin_Click"  />
            ...
            <asp:Label ID="Label2" runat="server" Text="Podaj ID rekordu do usunięcia:" CssClass="label-user2" ></asp:Label>
                                <asp:TextBox ID="Pole_usun" Height="50px" BackColor="#deeafa"  runat ="server" BorderStyle="Solid" CssClass="input-age2" TextMode="Number" min="1" ></asp:TextBox> 
