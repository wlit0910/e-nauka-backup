<%@ Page Title="Continue Course" Language="C#" MasterPageFile="~/UserENG/UserEnglish.Master" AutoEventWireup="true" CodeBehind="ContinueCourseENG.aspx.cs" Inherits="e_nauka.UserENG.Formularz_internetowy12" %>
...
<div class="text-center" style="height:auto;margin-top:40px">  <%--height auto--%>
    ...
    <h1 class="display-4 text-center" style="font-family: Montserrat, sans-serif;display:flex;justify-content:center;margin-top:70px;font-weight: normal;">Started course:&ensp;
