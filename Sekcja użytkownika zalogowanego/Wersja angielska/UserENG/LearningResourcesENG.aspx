<%@ Page Title="Learning Resources" Language="C#" MasterPageFile="~/UserENG/UserEnglish.Master" AutoEventWireup="true" CodeBehind="LearningResourcesENG.aspx.cs" Inherits="e_nauka.UserENG.Formularz_internetowy13" %>
...
<div class="text-center" style="height:auto;margin-top:40px">  <%--height auto--%>
    ...
    <h1 class="display-4 text-center" style="font-family: Montserrat, sans-serif;display:flex;justify-content:center;margin-top:70px;font-weight: normal;">User Resources:&ensp;
    ...
    <p  style="font-family: Montserrat, sans-serif;font-weight: normal;font-size:25px;margin-top:25px;">Click on a lesson to go to the theory.</p>
    </div>
 ...
 <%--   Tutaj dane na STAŁO--%>
    ...
    <ItemTemplate>
        <div style="margin-bottom:100px;margin-left:80px;margin-top:80px;">
            <asp:LinkButton ID="lnkCourse5" runat="server" Text="Java course - beginner" CssClass="label-course-inactive" PostBackUrl="#" ToolTip="Your course" Enabled="false" />
                            ...
                            <div style="margin-left: 120px;margin-top:20px;">
                                <asp:Panel ID="Panel1" runat="server" Visible="true">
                                    ...
                                    <div style="display:flex;">
                                        <asp:HyperLink ID="HyperLink1" runat="server"   NavigateUrl='../Demp.aspx' CssClass="label-lesson-inactive" Enabled="false">Lesson 1. Java Basics</asp:HyperLink>
