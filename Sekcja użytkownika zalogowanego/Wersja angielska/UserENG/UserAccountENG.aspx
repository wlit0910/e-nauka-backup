<%@ Page Title="My Account" Language="C#" MasterPageFile="~/UserENG/UserEnglish.Master" AutoEventWireup="true" CodeBehind="UserAccountENG.aspx.cs" Inherits="e_nauka.UserENG.Formularz_internetowy14" %>
...
<div class="text-center" style="height:auto;margin-top:40px">  <%--height auto--%>
    ...
    <h1 class="display-4 text-center" style="font-family: Montserrat, sans-serif;display:flex;justify-content:center;margin-top:70px;font-weight: normal;">Account Information:&ensp;
        ...
        <asp:Label ID="User_param" runat="server" Text="@test" CssClass="label-user"></asp:Label>
         ...
         <div style="display:flex;">
          ...
          <div style="background-color:#ff8454;border-radius:20px;border-style:solid;border-color:#141414;margin-top:10px; width:60%;height:auto;justify-content:center;display: block;margin-left: auto;margin-right: auto;">
            ...
            <h1 style="font-family: Montserrat, sans-serif;display:flex;justify-content:center;font-weight: normal;font-size:35px;">User information</h1>
      ...
      <div style="margin: 30px 30px 0px 30px;display:flex;">
				<p style="font-weight: normal;font-size:20px;font-family: Montserrat, sans-serif;font-size:30px;">Name:&hairsp;&hairsp;&hairsp;&ensp;</p>
    ...
    font-size:30px;}</style>
      ...
      <div style="margin: 30px 30px 0px 30px;display:flex;">
				<p style="font-weight: normal;font-size:20px;font-family: Montserrat, sans-serif;font-size:30px;">Surname:&hairsp;&hairsp;&hairsp;&ensp;</p>
      ...
      <div style="margin: 30px 30px 0px 30px;display:flex;">
				<p style="font-weight: normal;font-size:20px;font-family: Montserrat, sans-serif;font-size:30px;">Gender:&hairsp;&hairsp;&hairsp;&ensp;</p>
    ...
    <div style="margin: 30px 30px 0px 30px;display:flex;">
				<p style="font-weight: normal;font-size:20px;font-family: Montserrat, sans-serif;font-size:30px;">Age:&hairsp;&hairsp;&hairsp;&ensp;</p>
      ...
      <div style="margin: 30px 30px 0px 30px;display:flex;">
        ...
        <div style="background-color:#ff8454;border-radius:20px;border-style:solid;border-color:#141414;margin-top:10px; width:60%;height:auto;justify-content:center;display: block;margin-left: auto;margin-right: auto;">
            ...
            <h1 style="font-family: Montserrat, sans-serif;display:flex;justify-content:center;font-weight: normal;font-size:35px;">User courses</h1>
...
font-weight: 500;font-size:22px;color:#bf0502; font-family: Montserrat, sans-serif;
             ...
             <div style="text-align:center;margin-top:20px;">
                <asp:Label ID="Info_Label" runat="server" Text="Note! If you change your login - remember your new login. Log out and log in again using your new login." ForeColor="#bf0502" CssClass="label-info" Visible="false" ></asp:Label>
            </div>
      ...
      <asp:Button ID="Edytuj_User" runat="server" Height="70px" BorderStyle="Solid" BorderColor="#141414" Text="Edit field" BackColor="#ff8454" CssClass="btnLogout" OnClick="Edytuj_User_Click"  />
...
<style>.dropdownAdmin { font-size:20px;font-family: Montserrat, sans-serif;font-weight: bold;color:black; border-radius:5px;opacity:0.8;margin-right:50px;}</style>
       <asp:DropDownList ID="Pole_User" runat="server" Height="50px" Font-Size="20px" CssClass="dropdownAdmin" BackColor="#fae1d7" Visible="false" style="text-align:center;border:solid;border-color:#777677;border-width:2px;margin-top:10px;">
                    ...
                    <asp:ListItem style="font-size:small;text-align:center;">Password</asp:ListItem>
                </asp:DropDownList>
          ...
          <%--      <input ID="Wiek_Rej" type="number" min="0" max="99" class="input-age" />--%>
                           ...
                           <asp:Button ID="Send_User" runat="server" Height="70px" BorderStyle="Solid" BorderColor="#141414" Text="Update" BackColor="#ff8454" CssClass="btnLogout" Visible="false" OnClick="Send_User_Click"  />
