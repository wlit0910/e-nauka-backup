<%@ Page Title="Projekt końcowy nr 2 C++" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="ProjectC01M02.aspx.cs" Inherits="e_nauka.User.Formularz_internetowy110" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  text-align: left;">
        ...
        <div class="text-center" style="height:auto;margin-top:30px;text-align:center;margin-left:40px;margin-right:40px;">
             <p  style="font-family: Montserrat, sans-serif;font-weight: normal;font-size:25px;margin-top:20px;margin-left:40px;margin-right:40px;text-align:justify;">
                 ...
                 Możesz także sprawdzić swój kod samodzielnie w zamieszczonym na dole strony <a href="ProjectC01M02.aspx#compiler" style="color:#ff8454;">kompilatorze online.</a>
             </p>
       </div>

                <div class="text-center" style="height:auto;margin-top:30px;text-align:center;">
                     <p style="font-family: Montserrat, sans-serif;font-weight: 500;font-size:30px;margin-top:50px;"><span style="background-color:#fcd9cc;">Temat projektu końcowego: "Kalkulator średniej ocen ucznia"</span></p>
               </div>

               <div style="height:auto;margin-top:30px;text-align:left;margin-left:80px;margin-right:40px;">
                     <p style="font-family: Montserrat, sans-serif;font-weight: normal;font-size:30px;margin-top:50px;"><span style="font-weight:500;">Opis:</span><span style="font-size:25px;">&ensp;&ensp;Napisz program, który pomoże użytkownikowi (nauczycielowi lub uczniowi) obliczyć średnią ocen z kilku przedmiotów. Program powinien:</span></p>
  ...
  text-align: left;">
                      ...
                      <li style="margin-bottom:10px;font-weight:normal;">Poprosić użytkownika o podanie liczby przedmiotów.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Dla każdego przedmiotu użytkownik poda nazwę przedmiotu oraz ocenę (w formacie: 1-6).</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Program policzy średnią ocen i wyświetli ją na ekranie.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Program powinien posiadać funkcję do obliczania średniej oraz wskaźnik do manipulacji danymi ocen.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Użytkownik będzie miał możliwość edytowania ocen po ich wprowadzeniu.</li>
                 </ul>
  ...
  text-align: left;">
                      ...
                      <li style="margin-bottom:10px;font-weight:normal;">Wykorzystaj pętle do pobrania danych od użytkownika (np. oceny dla każdego przedmiotu).</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Przechowaj dane w tablicach (jedna tablica dla ocen, druga dla nazw przedmiotów).</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Napisz funkcję do obliczania średniej ocen.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Wykorzystaj wskaźnik, aby zmieniać oceny w tablicy.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Program powinien mieć opcję modyfikacji oceny po wprowadzeniu wszystkich danych.</li>
                 </ul>
