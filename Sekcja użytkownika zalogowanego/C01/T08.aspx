<%@ Page Title="Klasy, obiekty" Language="C#" MasterPageFile="~/Task.Master" AutoEventWireup="true" CodeBehind="T08.aspx.cs" Inherits="e_nauka.Formularz_internetowy120" %>
...
<%---------------------------------------------------- TASK LOG -----------------------------------------------------%>
    <div style="height:590px;max-height:600px; ">
              ...
              <p style="font-family: Montserrat, sans-serif;font-weight: normal;margin-left:40px;margin-right:40px;text-align:justify;margin-top:30px;">
               Dokończ program, który definiuje klasę Osoba z polami <span style="font-weight:bold;"> prywatnymi: </span>imie, wiek oraz <span style="font-weight:bold"> metodami publicznymi</span> ustawDane i pokazDane, które odpowiednio ustawiają wartość poszczególnych pól tworzonego obiektu i je wyświetlają.
                  </p>
