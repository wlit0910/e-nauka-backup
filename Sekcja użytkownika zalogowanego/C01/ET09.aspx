<%@ Page Title="Polymorphism. Inheritance" Language="C#" MasterPageFile="~/Task.Master" AutoEventWireup="true" CodeBehind="ET09.aspx.cs" Inherits="e_nauka.Formularz_internetowy9" %>
...
<%---------------------------------------------------- TASK LOG -----------------------------------------------------%>
    <div style="height:590px;max-height:600px; ">
              ...
              <p style="font-family: Montserrat, sans-serif;font-weight: normal;margin-left:40px;margin-right:40px;text-align:justify;margin-top:30px;">
               Complete the program that defines a <span style="font-weight:bold">base class Ksztalt</span> with a rysuj() method and one derived class Kolo. <br><br>The derived class should override the rysuj() method to display a different message.
                  </p>
