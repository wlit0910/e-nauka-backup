<%@ Page Title="Final Project No. 2 C++" Language="C#" MasterPageFile="~/UserENG/UserEnglish.Master" AutoEventWireup="true" CodeBehind="EProjectC01M02.aspx.cs" Inherits="e_nauka.UserENG.Formularz_internetowy21" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 class="display-4 text-center" style="font-family: Montserrat, sans-serif;display:flex;justify-content:center;margin-top:70px;font-weight: normal;font-size:50px;">Final project from the module:&ensp;
        ...
        <div class="text-center" style="height:auto;margin-top:30px;text-align:center;">
                     <p  style="font-family: Montserrat, sans-serif;font-weight: normal;font-size:30px;margin-top:40px;">Test your knowledge of the 3 lessons you have recently completed:</p>
  ...
  text-align: left;">
        ...
        <div class="text-center" style="height:auto;margin-top:30px;text-align:center;margin-left:40px;margin-right:40px;">
             <p  style="font-family: Montserrat, sans-serif;font-weight: normal;font-size:25px;margin-top:20px;margin-left:40px;margin-right:40px;text-align:justify;">
                 For this purpose, you can write a programming project, the topic and requirements of which are given below. You can send the resulting code in the format <span style="font-weight:500">.cpp / .txt</span> to the administrator, who will check the code, evaluate it and send you a reply. You can also check your code yourself in the <a href="EProjectC01M02.aspx#compiler" style="color:#ff8454;">online compiler</a> located at the bottom of the page.
             </p>
       </div>

                <div class="text-center" style="height:auto;margin-top:30px;text-align:center;">
                     <p style="font-family: Montserrat, sans-serif;font-weight: 500;font-size:30px;margin-top:50px;"><span style="background-color:#fcd9cc;">Final Project Topic: "Student Grade Point Average Calculator"</span></p>
               </div>

               <div style="height:auto;margin-top:30px;text-align:left;margin-left:80px;margin-right:40px;">
                     <p style="font-family: Montserrat, sans-serif;font-weight: normal;font-size:30px;margin-top:50px;"><span style="font-weight:500;">Description:</span><span style="font-size:25px;">&ensp;&ensp;Write a program that helps the user (teacher or student) calculate the average grade of several subjects. The program should:</span></p>
  ...
  text-align: left;">
                      ...
                      <li style="margin-bottom:10px;font-weight:normal;">Ask the user to enter the number of items.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">For each subject the user will provide the subject name and a rating (in format: 1-6).</li>
                      <li style="margin-bottom:10px;font-weight:normal;">The program will calculate the average grade and display it on the screen.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">The program should have a function to calculate the average and a pointer to manipulate the grade data.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">The user will have the option to edit ratings once they have been entered.</li>
                 </ul>
  ...
  text-align: left;">
                      ...
                      <li style="margin-bottom:10px;font-weight:normal;">Use loops to collect data from the user (e.g. grades for each subject).</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Store the data in arrays (one array for grades, another for subject names).</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Write a function to calculate grade point average.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Use the pointer to change the ratings in the board.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">The program should have the option to modify the rating after all the data has been entered.</li>
                 </ul>
