<%@ Page Title="Classes. Objects" Language="C#" MasterPageFile="~/Task.Master" AutoEventWireup="true" CodeBehind="ET08.aspx.cs" Inherits="e_nauka.Formularz_internetowy8" %>
...
<%---------------------------------------------------- TASK LOG -----------------------------------------------------%>
    <div style="height:590px;max-height:600px; ">
              ...
              Complete the program that defines the Osoba class with <span style="font-weight:bold;">private </span>fields: imie, wiek oraz <span style="font-weight:bold">by public methods</span> ustawDane i pokazDane, which set the value of individual fields of the created object accordingly and display them.
                  </p>
...
<%---------------------------------------------------- COMPILER -----------------------------------------------------%>
   <div class="compiler">
  <div class="header">person_class.cpp</div>
        <div class="code-container">
            ...
            <div class="code">
                ...
                <span class="keyword">class</span> <span class="class-name">Osoba</span> {<br>
                &nbsp;&nbsp;<asp:TextBox ID="Task1" runat="server"  BorderWidth="0"  Width="85px" BackColor="#f0f0f0" ForeColor="blue" CssClass="keyword"></asp:TextBox><%-- zadanie wpisz - private--%><br>
                &nbsp;&nbsp;&nbsp;&nbsp;<span class="keyword">string</span> imie;<br>
                &nbsp;&nbsp;&nbsp;&nbsp;<span class="keyword">int</span> wiek;<br>
                &nbsp;&nbsp;<asp:TextBox ID="Task2" runat="server"  BorderWidth="0"  Width="75px" BackColor="#f0f0f0" ForeColor="blue" CssClass="keyword"></asp:TextBox><%-- zadanie wpisz - public --%><br>
                &nbsp;&nbsp;&nbsp;&nbsp;<span class="keyword">void</span> ustawDane(<span class="keyword">string</span> i, <span class="keyword">int</span> w) {<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;imie = i;<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;wiek = w;<br>
                &nbsp;&nbsp;&nbsp;&nbsp;}<br>
                &nbsp;&nbsp;&nbsp;&nbsp;<span class="keyword">void</span> pokazDane() {<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cout &lt;&lt; <span class="number">"Imię: "</span> &lt;&lt; imie &lt;&lt; <span class="number">", Wiek: "</span> &lt;&lt; wiek;<br>
                &nbsp;&nbsp;&nbsp;&nbsp;}<br>
                };<br>
               ...
               <div style="margin-top:-2px;">     
                &nbsp;&nbsp;<asp:TextBox ID="Task3" runat="server"  BorderWidth="0"  Width="55px" BackColor="#f0f0f0" ForeColor="Green" CssClass="class-name"></asp:TextBox><%-- zadanie wpisz - Osoba--%> osoba;<br>
                   </div>
                <div style="height:2px;">

                </div>
                &nbsp;&nbsp;<asp:TextBox ID="Task4" runat="server"  BorderWidth="0"  Width="152px" BackColor="#f0f0f0" ForeColor="Black" CssClass="other-code"></asp:TextBox><%-- zadanie wpisz - osoba.ustawDane--%>(<span class="number">"Jan"</span>, <span class="number">30</span>);<br>
                 <div style="height:2px;">

                </div>
                &nbsp;&nbsp;<asp:TextBox ID="Task5" runat="server"  BorderWidth="0"  Width="62px" BackColor="#f0f0f0" ForeColor="Black" CssClass="other-code"></asp:TextBox><%-- zadanie wpisz - osoba. --%>pokazDane();<br>
