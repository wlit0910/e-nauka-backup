<%@ Page Title="Wskaźniki" Language="C#" MasterPageFile="~/Task.Master" AutoEventWireup="true" CodeBehind="T06.aspx.cs" Inherits="e_nauka.Formularz_internetowy3" %>
...
<%---------------------------------------------------- TASK LOG -----------------------------------------------------%>
    <div style="height:590px;max-height:600px; ">
              ...
              <p style="font-family: Montserrat, sans-serif;font-weight: normal;margin-left:40px;margin-right:40px;text-align:justify;margin-top:30px;">
                  Dokończ program, który <span style="font-weight:bold;">deklaruje wskaźnik do zmiennej</span>, <span style="font-weight:bold">zmienia wartość zmiennej</span> za pomocą wskaźnika i<br>wyświetla <span style="font-weight:bold">obie wartości</span>.
                  </p>
