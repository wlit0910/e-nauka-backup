<%@ Page Title="Funkcje" Language="C#" MasterPageFile="~/Task.Master" AutoEventWireup="true" CodeBehind="T05.aspx.cs" Inherits="e_nauka.Formularz_internetowy2" %>
...
<%---------------------------------------------------- TASK LOG -----------------------------------------------------%>
    <div style="height:590px;max-height:600px; ">
              ...
              <p style="font-family: Montserrat, sans-serif;font-weight: normal;margin-left:40px;margin-right:40px;text-align:justify;margin-top:30px;">
                  Dokończ program, który posiada funkcję silnia, która oblicza silnię liczby podanej przez użytkownika.
                  </p>
