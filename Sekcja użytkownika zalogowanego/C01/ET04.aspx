<%@ Page Title="Loop. Arrays" Language="C#" MasterPageFile="~/Task.Master" AutoEventWireup="true" CodeBehind="ET04.aspx.cs" Inherits="e_nauka.Formularz_internetowy41" %>
...
<%---------------------------------------------------- TASK LOG -----------------------------------------------------%>
    <div style="height:590px;max-height:600px; ">
              ...
              <p style="font-family: Montserrat, sans-serif;font-weight: normal;margin-left:40px;margin-right:40px;text-align:justify;margin-top:30px;">
                 Complete a program that asks the user to enter 5 numbers and then displays those numbers in reverse order.
                  </p>
...
<div class="code">
                ...
                &nbsp;&nbsp;<span class="comment">// Getting numbers from the user</span><br>
    ...
    <asp:TextBox ID="Task2" runat="server"  BorderWidth="0"  Width="35px" BackColor="#f0f0f0" ForeColor="black" CssClass="other-code"></asp:TextBox><%-- zadanie wpisz - i++ --%>) {<br>
                ...
                &nbsp;&nbsp;}<br><br>
                &nbsp;&nbsp;<span class="comment">// Displaying numbers in reverse order</span><br>
...
<%---------------------------------------------------- OUTPUT LOG -----------------------------------------------------%>
   ...
   .label-rest {margin-top:-5px;font-family: 'Courier New', Courier, monospace;font-weight: bold;margin-left:10px;color:#ff8454;margin-bottom:0px;}
        ...
        <asp:Label ID="Output" runat="server" Text="Enter a non-negative number:" CssClass="label-output" Visible="false" ></asp:Label> <asp:TextBox ID="Param" runat="server"  BorderWidth="1"  Width="45px" BackColor="black" ForeColor="#ff8454" Text="" CssClass="label-output" BorderColor="Orange" BorderStyle="Solid" Visible="false"></asp:TextBox>
        <br><asp:Label ID="Output2" runat="server" Text="Enter a non-negative number:" CssClass="label-output" Visible="false" ></asp:Label> <asp:TextBox ID="Param2" runat="server"  BorderWidth="1"  Width="45px" BackColor="black" ForeColor="#ff8454" Text="" CssClass="label-output" BorderColor="Orange" BorderStyle="Solid" Visible="false"></asp:TextBox>
        <br><asp:Label ID="Output3" runat="server" Text="Enter a non-negative number:" CssClass="label-output" Visible="false" ></asp:Label> <asp:TextBox ID="Param3" runat="server"  BorderWidth="1"  Width="45px" BackColor="black" ForeColor="#ff8454" Text="" CssClass="label-output" BorderColor="Orange" BorderStyle="Solid" Visible="false"></asp:TextBox>
        <br><asp:Label ID="Output4" runat="server" Text="Enter a non-negative number:" CssClass="label-output" Visible="false" ></asp:Label> <asp:TextBox ID="Param4" runat="server"  BorderWidth="1"  Width="45px" BackColor="black" ForeColor="#ff8454" Text="" CssClass="label-output" BorderColor="Orange" BorderStyle="Solid" Visible="false"></asp:TextBox>
        <br><asp:Label ID="Output5" runat="server" Text="Enter a non-negative number:" CssClass="label-output" Visible="false" ></asp:Label> <asp:TextBox ID="Param5" runat="server"  BorderWidth="1"  Width="45px" BackColor="black" ForeColor="#ff8454" Text="" CssClass="label-output" BorderColor="Orange" BorderStyle="Solid" Visible="false"></asp:TextBox>
        <br><asp:Label ID="Output6" runat="server" Text="Enter a non-negative number:" CssClass="label-output" Visible="false" ></asp:Label> <asp:TextBox ID="Param6" runat="server"  BorderWidth="1"  Width="45px" BackColor="black" ForeColor="#ff8454" Text="" CssClass="label-output" BorderColor="Orange" BorderStyle="Solid" Visible="false"></asp:TextBox> 
