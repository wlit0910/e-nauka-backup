<%@ Page Title="Structures" Language="C#" MasterPageFile="~/Task.Master" AutoEventWireup="true" CodeBehind="ET07.aspx.cs" Inherits="e_nauka.Formularz_internetowy7" %>
...
<%---------------------------------------------------- TASK LOG -----------------------------------------------------%>
    <div style="height:590px;max-height:600px; ">
              ...
              <p style="font-family: Montserrat, sans-serif;font-weight: normal;margin-left:40px;margin-right:40px;text-align:justify;margin-top:30px;">
               Complete the program that defines <span style="font-weight:bold;">structure Samochod</span> with fields: marka, model, rok_produkcji i cena.<br><br>Then create three objects of this structure and<span style="font-weight:bold;"> display specific data </span> about cars:
