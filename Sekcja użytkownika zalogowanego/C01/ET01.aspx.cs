...
namespace e_nauka
{
    public partial class Formularz_internetowy126 : System.Web.UI.Page
    {
        ...
        protected void Next_Click(object sender, EventArgs e)
        {
            if (Output.Text == "Hello, World!") // potem sprawdz z BD status zadania
            {
                ...
                // sprawdz i zaktualizuj statusu lekcji
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    // sprawdz, czy istnieje wpis w PROGRESS
                    ...
                    using (SqlCommand cmd = new SqlCommand(insertOrUpdateQuery, conn))
                    {
                        ...
                        if (rowsAffected > 0)
                        {
                            Response.Redirect("EL02.aspx");  // ------------------------------------------------------------- zmienić 
                        }
                        else
                        {
