<%@ Page Title="Final Project No. 3 C++" Language="C#" MasterPageFile="~/UserENG/UserEnglish.Master" AutoEventWireup="true" CodeBehind="EProjectC01M03.aspx.cs" Inherits="e_nauka.UserENG.Formularz_internetowy31" %>
  ...
  text-align: left;">
        ...
        <div class="text-center" style="height:auto;margin-top:30px;text-align:center;margin-left:40px;margin-right:40px;">
             <p  style="font-family: Montserrat, sans-serif;font-weight: normal;font-size:25px;margin-top:20px;margin-left:40px;margin-right:40px;text-align:justify;">
                For this purpose, you can write a programming project, the topic and requirements of which are given below. You can send the resulting code in the <span style="font-weight:500">.cpp / .txt</span> format to the administrator, who will check the code, evaluate it and send you a reply.
                 You can also check your code yourself in the <a href="EProjectC01M03.aspx#compiler" style="color:#ff8454;">online compiler</a> at the bottom of the page.
             </p>
       </div>

                <div class="text-center" style="height:auto;margin-top:30px;text-align:center;">
                     <p style="font-family: Montserrat, sans-serif;font-weight: 500;font-size:30px;margin-top:50px;"><span style="background-color:#fcd9cc;">Final project topic: "Fleet management system"</span></p>
               </div>
...
Create a program that simulates a fleet management system for a transport company. The program should handle different types of vehicles, such as cars, trucks, and bicycles.
Each vehicle will have its own attributes and methods, and some methods will work polymorphically.
You can use both structures (for technical data) and classes (for behavior and methods) to describe vehicles. The program should allow you to add new vehicles to the fleet, display information about them, and simulate their operation (e.g. driving, loading, etc.). Program functionalities:
                                                                                                                                                                   </span></p>
  ...
  text-align: left;">
                      ...
                      <li style="margin-bottom:10px;font-weight:normal;">Adding vehicles: The program should allow you to add new vehicles to the fleet.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Display information: The program should display detailed information about each vehicle, such as model, year of manufacture and mileage.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Polymorphic Method Invocation: The program will use polymorphism to handle different types of vehicles and invoke appropriate methods, such as<code> drive()</code> or <code>load()</code> .</li>
                 </ul>
                       ...
                       <div style="height:auto;margin-top:30px;text-align:left;margin-left:80px;margin-right:40px;">
                     <p style="font-family: Montserrat, sans-serif;font-weight: normal;font-size:30px;margin-top:50px;"><span style="font-weight:500;">Requirements:</span></p>
             <ul style="font-family: Montserrat, sans-serif;font-weight: normal;margin-left:40px;margin-right:40px;margin-top:10px;  display: inline-block;font-size:25px;
  text-align: left;">

                      <li style="margin-bottom:10px;font-weight:normal;">Structures: Use structures to store specific technical information about vehicles (e.g. model, year of manufacture, mileage).</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Classes and Objects: Each type of vehicle should be represented by a class. The base class should contain basic methods such as <code>drive()</code> or<code> load()</code> (for trucks).</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Inheritance: Classes that inherit from a base class should extend functionality with behavior specific to a given vehicle type.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Polymorphism: Use polymorphism to call appropriate methods depending on the vehicle type.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Additional functions: The program should include the option of displaying information about all vehicles in the fleet (including data defined in structures) and simulating vehicle operation.</li>
                 </ul>
