...
{
    public partial class Formularz_internetowy111 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("SELECT NAME FROM MODULE WHERE mID = 3", conn);
            ...
            try
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("SELECT NAME FROM LESSONS WHERE mID = 3", conn);
                    SqlDataReader reader = cmd.ExecuteReader();
