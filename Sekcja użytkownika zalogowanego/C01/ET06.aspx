<%@ Page Title="Pointers" Language="C#" MasterPageFile="~/Task.Master" AutoEventWireup="true" CodeBehind="ET06.aspx.cs" Inherits="e_nauka.Formularz_internetowy6" %>
...
<%---------------------------------------------------- TASK LOG -----------------------------------------------------%>
    <div style="height:590px;max-height:600px; ">
              ...
              <p style="font-family: Montserrat, sans-serif;font-weight: normal;margin-left:40px;margin-right:40px;text-align:justify;margin-top:30px;">
                 Complete the program that <span style="font-weight:bold;">declares a pointer to a variable</span>, <span style="font-weight:bold">changes the value of a variable</span> using the pointer and<br>displays <span style="font-weight:bold">both values</span>.
                  </p>
...
<%---------------------------------------------------- COMPILER -----------------------------------------------------%>
   <div class="compiler">
  <div class="header">pointer_example.cpp</div>
...
<div class="code">
                ...
                &nbsp;&nbsp;<span class="keyword">int</span> liczba = <span class="number">10</span>;<br>
                &nbsp;&nbsp;<span class="keyword">int</span> <asp:TextBox ID="Task1" runat="server"  BorderWidth="0"  Width="15px" BackColor="#f0f0f0" ForeColor="black" CssClass="other-code"></asp:TextBox><%-- zadanie wpisz * --%>wsk 
    = <asp:TextBox ID="Task2" runat="server"  BorderWidth="0"  Width="15px" BackColor="#f0f0f0" ForeColor="black" CssClass="other-code"></asp:TextBox>liczba;<%-- zadanie wpisz & --%><br><br>
                &nbsp;&nbsp;cout &lt;&lt; <span class="number">"Przed zmiana: "</span> &lt;&lt; liczba &lt;&lt; endl;<br>
                &nbsp;&nbsp;<asp:TextBox ID="Task3" runat="server"  BorderWidth="0"  Width="15px" BackColor="#f0f0f0" ForeColor="black" CssClass="other-code"></asp:TextBox><%-- zadanie wpisz * --%>wsk = <span class="number">20</span>;  <span class="comment">// Zmiana wartości za pomocą wskaźnika</span><br>
                &nbsp;&nbsp;cout &lt;&lt; <span class="number">"Po zmianie: "</span> &lt;&lt; liczba &lt;&lt; endl;<br><br>
