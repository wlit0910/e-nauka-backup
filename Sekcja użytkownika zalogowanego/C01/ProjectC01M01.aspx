<%@ Page Title="Projekt końcowy nr 1 C++" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="ProjectC01M01.aspx.cs" Inherits="e_nauka.User.Formularz_internetowy19" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="height:auto;">
        <div class="text-center" style="height:auto;margin-top:40px"> 
  ...
  text-align: left;">
        ...
        <div class="text-center" style="height:auto;margin-top:30px;text-align:center;margin-left:40px;margin-right:40px;">
             <p  style="font-family: Montserrat, sans-serif;font-weight: normal;font-size:25px;margin-top:20px;margin-left:40px;margin-right:40px;text-align:justify;">
                 ...
                 Możesz także sprawdzić swój kod samodzielnie w zamieszczonym na dole strony <a href="ProjectC01M01.aspx#compiler" style="color:#ff8454;">kompilatorze online.</a>
             </p>
       </div>

                <div class="text-center" style="height:auto;margin-top:30px;text-align:center;">
                     <p style="font-family: Montserrat, sans-serif;font-weight: 500;font-size:30px;margin-top:50px;"><span style="background-color:#fcd9cc;">Temat projektu końcowego: "Kalkulator BMI (Body Mass Index)"</span></p>
               </div>

               <div style="height:auto;margin-top:30px;text-align:left;margin-left:80px;margin-right:40px;">
                     <p style="font-family: Montserrat, sans-serif;font-weight: normal;font-size:30px;margin-top:50px;"><span style="font-weight:500;">Opis:</span><span style="font-size:25px;">&ensp;&ensp;Stwórz prostą aplikację w C++, która obliczy wskaźnik BMI użytkownika na podstawie wprowadzonej wagi i wzrostu. Program powinien także wyświetlać odpowiedni komunikat, informując użytkownika, czy jego BMI mieści się w normie, czy może sugeruje nadwagę lub niedowagę. 
                         Projekt ma na celu praktyczne wykorzystanie zmiennych, stałych, typów danych, operatorów matematycznych oraz instrukcji warunkowych. Wymagania projektu:</span></p>
  ...
  text-align: left;">
                      ...
                      <li style="margin-bottom:10px;font-weight:normal;">Program musi umożliwiać użytkownikowi wprowadzenie wzrostu (w metrach) oraz wagi (w kilogramach).</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Oblicz BMI według wzoru BMI = (waga) / (wzrost^2).</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Wykorzystaj odpowiednie typy danych do przechowywania wartości wagi, wzrostu oraz obliczonego BMI.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Użyj instrukcji warunkowych if, if-else do sprawdzenia, do jakiego przedziału BMI należy użytkownik: <a href="https://pl.wikipedia.org/wiki/Wska%C5%BAnik_masy_cia%C5%82a">BMI</a> </li>
                      <li style="margin-bottom:10px;font-weight:normal;">Program powinien wyświetlić odpowiednią wiadomość w zależności od obliczonego BMI.</li>
                      <li style="margin-bottom:10px;font-weight:normal;">Zastosuj operatory matematyczne do obliczeń, a logiczne w instrukcjach warunkowych.</li>
                 </ul>
